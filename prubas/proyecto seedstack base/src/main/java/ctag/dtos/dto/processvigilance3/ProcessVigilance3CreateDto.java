...
import ctag.domain.model.aggregate.modelospruebas.ProcessVigilance3;
...
@DtoOf(ProcessVigilance3.class)
@ApiModel(value = " ProcessVigilance3 ")
public class ProcessVigilance3CreateDto {
