...
private static final String MAPPED_BY_PROCESS_VIGILANCE_STATE = "processVigilanceState";   
private static final String GENERATOR = "ProcessVigilanceStateGen";
  ...
  @OneToMany(mappedBy = MAPPED_BY_PROCESS_VIGILANCE_STATE, cascade = CascadeType.ALL, fetch = FetchType.LAZY)
