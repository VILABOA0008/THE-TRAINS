...
public class Dto {
  ...
  public static String createDtoOld(String agg, ArrayList<String> fieldsType,
    ...
    a += "\n@DtoOf(" + agg + ".class)\n" +
        "public class " + agg + "Representation {\n\n";

    a += "  private Integer id" + agg + ";\n";
    ...
    for (int i = 0; i < fieldsType.size(); i++) {
      a += " @MatchingFactoryParameter(index = " + (i+1) + ")\n" +
    ...
    for (int i = 0; i < fkmoVarFinal.size(); i++) {
      ...
      a += "  @MatchingFactoryParameter(index = " + ((fieldsType.size() + i)+1) + ")\n" +
    ...
    a += "  public void setId" + agg + "(Integer id" + agg + ") {\n" +
        "    this.id" + agg + " = id" + agg + ";\n" +
        "  }";
